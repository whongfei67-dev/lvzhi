      ...
      <div className="bg-white border-b border-[rgba(212,165,116,0.25)]">
        <div className="mx-auto max-w-4xl px-6 py-10 lg:px-8">
          ...
          <div className="mt-6 flex items-start gap-4">
            <Building2 className="h-12 w-12 text-[#D4A574]" />
            <div><h1 className="text-3xl font-bold text-[#2C2416]">企业定制</h1><p className="mt-2 text-lg text-[#5D4E3A]">为企业提供专属智能体开发与部署服务</p></div>
          </div>
        </div>
      </div>
      <div className="mx-auto max-w-4xl px-6 py-12 lg:px-8">
        <div className="rounded-3xl border border-[rgba(212,165,116,0.25)] bg-white p-8 shadow-sm">
          <h2 className="text-xl font-bold">提交定制需求</h2>
          <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="mt-6 space-y-4">
            ...
            <input required placeholder="公司名称" className="h-12 w-full rounded-2xl border border-[rgba(212,165,116,0.25)] bg-[rgba(212,165,116,0.08)] px-4 text-sm" />
            ...
            <textarea rows={4} placeholder="定制需求说明..." className="w-full rounded-2xl border border-[rgba(212,165,116,0.25)] bg-[rgba(212,165,116,0.08)] px-4 py-3 text-sm resize-none" />
            <button type="submit" className="w-full rounded-2xl bg-gradient-to-r from-[#D4A574] to-purple-600 px-4 py-3 text-sm font-semibold text-white">提交申请</button>
          </form>
        </div>
      </div>
    </div>
